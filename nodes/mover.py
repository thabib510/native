...
This node was originally done in a ROS package called "p3dx_mover". Their goal was to control a P3-DX using the keyboard arrow keys. We, Team NATIVE, modified that code to apply the same commands to our ARC's arrow keys and Joystick Keys using a UDP server. 
'''

# All of the relevant libraries
#import roslib; roslib.load_manifest('native')
import rospy
from socket import *
import re
...
if rospy.has_param("cmd_vel_topic"):
	topic = rospy.get_param("cmd_vel_topic")
else:
